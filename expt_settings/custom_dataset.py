...
import utils
import get_single_col_by_input_type
import extract_cols_from_data_type
from data_formatters.BTCUSDT import BTCUSDTFormatter
from data_formatters.base import DataTypes, InputTypes

class TFTDataset(Dataset, BTCUSDTFormatter):
    """Dataset Basic Structure for Temporal Fusion Transformer"""

    def __init__(self, 
                 data_df):
        super(BTCUSDTFormatter, self).__init__()
        """
        Args:
